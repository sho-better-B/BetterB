<template>
   ...
   <input v-model="description" placeholder="description" class="solo-input-diet">
   <button @click="showinputs(),addRecipe() " class="diet-button">Add recipe</button>
...
<div class="dietBlock">
  ...
  <button @click="deleteData(item._id)" class="diet-button">delete</button>
  </div>
  </div>
</div>
...
.diet-button  {display: inline-block;
                outline: 0;
                border: 0;
                cursor: pointer;
                background: #000000;
