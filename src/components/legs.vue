<template>
    <v-flex>
        <v-list-item :key="index" v-for="(item, index) in legss">
          <div>
            <br>
        ...
        <div>
          <button @click="addlegss()">ADD NEW ONE</button>
...
import ILegs from "@/components/interface/interfaceLegs";
@Component
export default class Legs extends Vue {
  ...
  async mounted(): Promise<void> {
    this.legss = await legssApi.getAlllegss();
       ...
       async addlegss(){
   return legssApi.addlegss(this.exercise,this.gif,this.description)
  }
      async deleteData(id:string){
return legssApi.deletelegss(id)
  }
}
</script>
